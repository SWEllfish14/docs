...
Vista l'adozione del framework scrum, il team ha deciso di far ruotare i ruoli dei componenti in corrispondenza della fine dello sprint, seguendo un ordine di tipo alfabetico.
...
\begin{itemize}
    ...
    \item Tabella con le modifiche fatte e relativo numero di versionamento
