...
\addversione{0.0.2}{23/04/2023}{Andrea Veronese}{Davide Porporati}{Aggiunte sezioni verifica e scrum}
\makeversioni
...
I colloqui vengono richiesti via mail oppure via telegram, tramite l'apposito gruppo creato con il responsabile incaricato di Imola Informatica.
...
Vista l'adozione del framework scrum il team ha deciso di far ruotare i ruoli dei vari componenti in corrispondenza della fine dello sprint, seguendo un ordine di tipo alfabetico.
...
Per agevolare l'attività di documentazione è stata creata una board denominata "To-Do Documenti", dove di settimana in settimana vengono aggiunte nuove issue riguardanti la creazione o la modifica dei documenti da affrontare nel prossimo sprint.
...
Sono state applicate delle specifiche regole da adottare per la nomenclatura dei verbali e ogni il nome del documento dovrà rispettare la seguente struttura:
\begin{itemize}
    \item verbale
    \item data
