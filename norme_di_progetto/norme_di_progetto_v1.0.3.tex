...
\addversione{0.1.1}{12/07/2023}{Claudio Giaretta}{Andrea Veronese}{Aggiunti strumenti di codifica utilizzati e corrette alcune sezioni del documento}
\addversione{1.0.0}{19/07/2023}{Claudio Giaretta}{Davide Porporati, Andrea Veronese}{Revisione generale del documento e avanzamento di versione}
\addversione{1.0.1}{02/08/2023}{Claudio Giaretta}{Elena Marchioro}{Aggiornamento dei processi primari con attività ben definite}
\addversione{1.0.2}{05/08/2023}{Davide Porporati}{Elena Marchioro}{Aggiornamento dei processi secondari riorganizzate e riviste attività di verifica e validazione}
\addversione{1.0.3}{06/08/2023}{Davide Porporati}{Francesco Naletto}{Aggiornato i processi organizzativi, indicate chiaramente le attività dei processi e specificato il compito di ogni ruolo}
\makeversioni
...
Si procede a realizzare la lettera di candidatura dove si dichiara l'impegno preso e si indicano le risorse e i costi preventivati per la realizzazione del capitolato.
...
Viene presentato al proponente e al committente il prodotto finale, che dovrà soddisfare tutti i requisiti fissati nel file di \textit{Analisi dei requisiti}
...
\begin{itemize}
    ...
    \item Gli spazi vengono rappresentati con il simbolo "\_"
    \item Tutti i file ad eccezione fatta per la "lettera di presentazione" e verbali devono terminare con la versione del documento
\end{itemize}
...
Controlla che le risorse siano presenti e operanti, inoltre gestisce la documenetazione e controlla il versionamento e la configurazione. In particolare:
\begin{itemize}
    \item Gestisce i documenti e il loro versionamento
    \item Controlla che vengano rispettate le norme di progetto
    \item Controlla che vengano rispettati i parametri e le procedure per la gestione della qualità
    \item Si occupa di controllare l'ambiente di sviluppo e mantenere efficiente la cooperazione dei membri del gruppo 
\end{itemize}
\textbf{Analista}\\
