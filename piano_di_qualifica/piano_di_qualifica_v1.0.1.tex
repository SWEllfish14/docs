...
Le sigle dei requisiti sono state ottenunte dal file "analisi dei requisiti"
...
\begin{table}[htbp]
	...
	\begin{tabular}{|c|p{4cm}|c|c|}
	  \hline
	  \textbf{ID test} & \textbf{Descrizione} & \textbf{Requisito} & \textbf{Stato implementazione} \\
	  \hline
	  1 & \makecell{Test di funzionalità\\ X} & REQ-001 & Completato \\
	  \hline
	  2 & \makecell{Test di prestazione\\ Y} & REQ-005 & In corso \\
	  \hline
	  3 & \makecell{Test di usabilità\\ Z} & REQ-010 & Da iniziare \\
	  \hline
	\end{tabular}
  \end{table}
