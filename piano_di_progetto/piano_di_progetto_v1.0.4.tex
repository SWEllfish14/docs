...
\begin{center}
	\begin{tabularx}{\textwidth}{|X|X|X|X|}
		...
		\multicolumn{4}{|c|}{\textbf{Ore effettive}}                                      \\														
		\hline														
		Responsabile		&		30		&		63(+6)		&		180		\\
		\hline														
		Amministratore		&		20		&		59(+3)		&		60		\\
		\hline														
		Analista		&		25		&		86(+3)		&		75		\\
		\hline														
		Progettista		&		25		&		120(+11)		&		275		\\
		\hline														
		Programmatore		&		15		&		135(+0)		&		0		\\
		\hline														
		Verificatore		&		15		&		109(+12)		&		180		\\
		\hline														
...
Il gruppo aveva preventivato inoltre che il progettista non sarebbe entrato in questa fase di progetto, successivamente, però, è stata valutata la necessità di affinacare un progettista durante la fase di analisi per poter valutare ...
...
La suddivisione dei ruoli è delle tasks è stata più facile di quanto preventivato, ciò si è tradotto in una diminuzione delle ore spese dal responsabile.
Il costo e le ore hanno comunque soddisfatto le aspettative del gruppo 
...
\begin{xltabular}{\linewidth}{|>{\hsize=0.25\hsize}X|X|X|X|}
	...
	& Dedicato più tempo ai programmatori per risolvere risolvere il problema                           
