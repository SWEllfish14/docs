...
\addversione{1.0.0}{09/08/2023}{Andrea Veronese}{Davide Porporati, Claudio Giaretta}{Aggiunti preventivi e consuntivo RTB}
\addversione{1.0.1}{10/08/2023}{Claudio Giaretta}{Francesco Naletto}{Aggiunto resoconto dodicesimo sprint e problematiche}
\addversione{1.0.2}{17/08/2023}{Claudio Giaretta}{Francesco Naletto}{Aggiunto resoconto tredicesimo sprint e problematiche}
\addversione{1.0.3}{24/08/2023}{Elena Marchioro}{Francesco Naletto}{Aggiunto resoconto quattordicesimo sprint e problematiche}
\addversione{1.0.4}{30/08/2023}{Davide Porporati}{Claudio Giaretta}{Aggiunto resoconto quindicesiomo sprint e problematiche}
\addversione{1.0.5}{07/09/2023}{Claudio Giaretta}{Davide Porporati}{Aggiunto resoconto sedicesimo sprint e problematiche}
\addversione{1.0.6}{14/09/2023}{Claudio Giaretta}{Davide Porporati}{Aggiunto resoconto diciasettesimo sprint e problematiche}
\addversione{1.0.7}{15/09/2023}{Francesco Naletto}{Claudio Giaretta}{Aggiunto consuntivo periodo MVP e fatta valutazione rischi}
\makeversioni
...
\begin{center}
	\begin{tabularx}{\textwidth}{|X|X|X|X|}										
		...
		\hline									
		Verificatore    &	15		&	24		&	375		\\
		\hline									
		\textbf{Totale} &			&	144		&	2820		\\
		\hline																	
	\end{tabularx}\\[8pt]										
	\mbox{}\\
\end{center}
...
\subsection{Sprint 1}
Qui vengono riportate le informazioni relative alla seconda settimana di sprint del gruppo. \\
...
\end{center}
\subsubsection{Problematiche riscontrate}
Difficoltà nell’apprendere l’utilizzo del framework Bulma.io per poter utilizzare in maniera efficace lo sviluppo della parte di CSS.
...
\end{center}
\subsubsection{Problematiche riscontrate}
Difficoltà nell’utilizzo delle API per interazioni con i lampioni
...
\begin{center}
	\begin{tabularx}{\textwidth}{|X|X|X|X|}
		...
		\hline														
		Programmatore		&		15		&		107(+27)		&		405		\\
		\hline														
		Verificatore		&		15		&		65(+9)		&		135		\\
		\hline														
		\hline														
...
\begin{center}
	\begin{tabularx}{\textwidth}{|X|X|X|X|}
		...
		\hline														
		Programmatore		&		15		&		125(+18)		&		270		\\
		\hline														
		Verificatore		&		15		&		79(+14)		&		210		\\
		\hline														
		\hline														
...
\begin{center}
	\begin{tabularx}{\textwidth}{|X|X|X|X|}
		...
		\hline														
		Programmatore		&		15		&		135(+10)		&		150		\\
		\hline														
		Verificatore		&		15		&		97(+18)		&		270		\\
		\hline														
		\textbf{Totale}		&				&		535		&		11110		\\
		\hline														
...
Qui vengono riportate le informazioni relative alla diciottesima settimana di sprint del gruppo. \\
In questo ciclo di sprint sono stati completati e revisionati tutti i documenti e la parte di testing del MVP.
È stata poi richiesto un incontro con il proponente per mostrare il prodotto finito.

Caratteristiche:

\begin{itemize}
	\item Data inizio: 07/09/2023
	\item Data fine preventivata: 14/09/2023
	\item Data fine effettiva: 14/09/2023
\end{itemize}
\subsubsection{Pianificazione}
\begin{center}
	\begin{tabularx}{\textwidth}{|X|X|}
...
\end{center}											
\subsubsection{Problematiche riscontrate}
È stata riscontrata una difficoltà nell'organizzare l'incontro con il proponente per via di impegni lavorativi di quest'ultimo.
...
\begin{center}
	\begin{tabularx}{\textwidth}{|X|X|X|X|}
		...
		\multicolumn{4}{|c|}{\textbf{Ore effettive}}                                      \\														
		\hline														
		Responsabile		&		30		&		63(+6)		&		1890		\\
		\hline														
		Amministratore		&		20		&		59(+3)		&		1180		\\
		\hline														
		Analista		&		25		&		86(+3)		&		2150		\\
		\hline														
		Progettista		&		25		&		120(+11)		&		275		\\
		\hline														
		Programmatore		&		15		&		135(+0)		&		3000		\\
		\hline														
		Verificatore		&		15		&		109(+12)		&		2025		\\
		\hline														
		\textbf{Totale}		&				&		572		&		11880		\\
		\hline														
...
\subsubsection{Tabella ore/costi}
\begin{center}
	\begin{tabularx}{\textwidth}{|X|X|X|X|}
		\hline
		\multicolumn{4}{|c|}{\textbf{Preventivo ore/costi}}                                      \\
...
L'analisi del problema e l'individuazione dei requisiti ha richiesto leggermente meno tempo di quanto preventivato, per questo motivo è stata risparmiata qualche ora da parte degli analisti e amministratori.
Il gruppo aveva preventivato inoltre che il progettista non sarebbe entrato in questa fase di progetto, successivamente, però, è stata valutata la necessità di affiancare un progettista durante la fase di analisi per poter valutare ...
È stato necessario inoltre un leggero incremento delle ore spese dal verificatore dovuto alla grande mole di documenti redatti in questa fase.
Il costo e le ore hanno comunque soddisfatto le aspettative del gruppo.
...
\subsubsection{Considerazioni}
La progettazione del POC è andata secondo quanto previsto dal gruppo, per la parte di codifica, invece, sono state richieste più ore in quanto è stata espressa da alcuni membri del gruppo la volontà di mantenere come base il POC per la fase successiva del progetto. Il gruppo quindi ha deciso di spendere alcune ore in più per rendere il codice facilmente estendibile.
La suddivisione dei ruoli e delle tasks è stata più facile di quanto preventivato, ciò si è tradotto in una diminuzione delle ore spese dal responsabile.
Il costo e le ore hanno comunque soddisfatto le aspettative del gruppo 

\subsection{Progettazione e codifica MVP}
...
\begin{center}
	\begin{tabularx}{\textwidth}{|X|X|X|X|}										
		...
		Responsabile    &	30		&	24		&	720		\\
		\hline									
		Amministratore  &	20		&	28(-6)		&	560(-120)		\\
		\hline									
		Analista        &	25		&	29(-2)		&	725(-50)		\\
		\hline									
		Progettista     &	25		&	82		&	2050		\\
		\hline									
		Programmatore   &	15		&	67		&	1005		\\
		\hline									
		Verificatore    &	15		&	61(+10)		&	915(+150)		\\
		\hline									
		\textbf{Totale} &			&	291(+2)		&	5975(-20)		\\
		\hline									
	\end{tabularx}\\[8pt]										
	\mbox{}\\
\end{center}
...
\subsubsection{Considerazioni}
La progettazione e la codifica del MVP sono procedute come da preventivo. La verifica ha richiesto diverse ore in più in quanto nel RTB il gruppo non aveva pianificato la fase di testing che quindi ha reso il processo di verifica del prodotto più lento.
I controlli fatti dall'amministratore hanno inoltre necessitato meno ore di quanto preventivato dal gruppo.
Il costo e le ore hanno comunque soddisfatto le aspettative del gruppo 
\section{Valutazione dei Rischi}
\begin{xltabular}{\linewidth}{|>{\hsize=0.25\hsize}X|X|X|X|}

	\hline
	\textbf{ID} & \textbf{Descrizione} & \textbf{Mitigazione} & \textbf{Conclusioni} \\
	\hline
	\endfirsthead
	\hline
	\textbf{ID} & \textbf{Descrizione} & \textbf{Mitigazione} & \textbf{Conclusioni} \\
	...
	\multicolumn{4}{|c|}{\textbf{Sprint 0}}                                                                                                                                                                                                                                                                                                                                                                      \\ \hline
	-   & Nessun rischio riscontrato.                                                                                                           
	& -                                                                                               
	& -                                                                                                                                                   \\ \hline
	\multicolumn{4}{|c|}{\textbf{Sprint 1}}                                                                                                                                                                                                                                                                                                                                                                       \\ \hline
	\textbf{RI2} & Problematica nella strutturazione del way of working       
	& Differenze di approccio dei vari membri del gruppo discusse durante il meeting settimanale                              
	& Il meeting ha risolto i dubbi e le divergenze sul metodo di lavoro dei vari membri del gruppo, facilitando la stesura del documento \textit{Norme di progetto}   \\ \hline
	
	\textbf{RO1} & Sovrapposizione della riunione di termine dello sprint con la consegna del diario di bordo.                                                                 
	& Anticipato di un giorno l'inizio e il termine degli sprint                                          
	& L'anticipazione della fine dello sprint ha permesso di svolgere il meeting settimanale senza la fretta di consegnare il diario di bordo                                                                                \\ \hline
	\multicolumn{4}{|c|}{\textbf{Sprint 2}}                                                                                                                                                                                                                                                                                                                                                                      \\ \hline
	\textbf{RR2} & Incomprensione su chi dovessero essere i protagonisti nei casi d'uso.                                                                 
	& È stata contattata l'azienda per chiedere chiarimenti.                                          
	& La stesura dei casi d'uso è potuta procedere senza rallentamenti.   \\ \hline
	\textbf{RTI} & Difficoltà nella scelta delle metriche di qualità da adottare                                                                
	& Sono state dedicate più ore all'approfondimento e valutazione di metriche soddisfacenti                                          
	& La stesura delle metriche all'interno del \textit{Piano di qualifica} è proceduta correttamente   \\ \hline
	\multicolumn{4}{|c|}{\textbf{Sprint 3}}                                                                                                                                                                                                                                                                                                                                                                      \\ \hline
	-   & Nessun rischio riscontrato.                                                                                                           
	& -                                                                                               & -                                                                                                                                                   \\ \hline
	\multicolumn{4}{|c|}{\textbf{Sprint 4}  }                                                                                                                                                                                                                                                                                                                                                                    \\ \hline
	\textbf{RR2}& Dubbi sulla realizzazione degli UML                                                                                                   
	& È stata contattato il professor Cardin per chiedere chiarimenti.                                
	& L'aiuto del professor Cardin ha sciolto i dubbi e le perplessità dei componenti.                                                                    \\ \hline
	\multicolumn{4}{|c|}{\textbf{Sprint 5}  }                                                                                                                                                                                                                                                                                                                                                                    \\ \hline
	\textbf{RT2} & Difficoltà di interfacciamento tra i simulatori dei lampioni.                                                                         
	& Dedicato più tempo ai programmatori per risolvere il problema                           
	& Lampioni e simulatori sono ora interfacciati correttamente                                                                       \\ \hline
	\multicolumn{4}{|c|}{\textbf{Sprint 6}   }                                                                                                                                                                                                                                                                                                                                                                   \\ \hline
	\textbf{RT1}   & Mancanza di conoscenza delle tecnologie da parte di alcuni membri del gruppo rallenta lo sviluppo del POC                                                                                                        
	& Aumentate le ore di impegno personale nell'apprendimento delle tecnologie e incentivata la comunicazione con chi ha già familiarità con quest'ultime                                                                                               
	& Migliorate le conoscenze sulle tecnologie usate e la comunicazione con i membri che hanno più esperienza d'uso delle tecnologie                                                                                                                                                   \\ \hline
	\multicolumn{4}{|c|}{\textbf{Sprint 7}   }                                                                                                                                                                                                                                                                                                                                                                   \\ \hline
	\textbf{RI1} & Diminuzione delle ore di lavoro a causa della sessione                                                                                
	& Le attività sono state equamente distribuite ed organizzate in modo efficace.                   
	& L'organizzazione delle attività è stata efficace, ma si è verificato uno scostamento rispetto alla tabella di marcia.                        \\ \hline
	\multicolumn{4}{|c|}{\textbf{Sprint 8}   }                                                                                                                                                                                                                                                                                                                                                                   \\ \hline
	\textbf{RI1}   & Mancanza di tempo a disposizione                                                                                                           
	& Affidato compiti che richiedevano più ore a chi aveva meno impegni, rispettando i ruoli forniti                                                                                           
	& Il problema è stato leggermente ridotto, ma non risolto.                                                                                                                                                   \\ \hline
	\multicolumn{4}{|c|}{\textbf{Sprint 9}  }                                                                                                                                                                                                                                                                                                                                                                   \\ \hline
	\textbf{RT1} & Difficoltà nell’apprendere l’utilizzo del framework Bulma.io per poter utilizzare in maniera efficace lo sviluppo della parte di CSS. 
	& Dedicate più ore ai programmatori per lo studio della tecnologia                                              
	& Migliorate le conoscenze sul framework                                                      \\ \hline
	\multicolumn{4}{|c|}{\textbf{Sprint 10}   }                                                                                                                                                                                                                                                                                                                                                                  \\ \hline
	\textbf{RT1}  & Difficoltà nell’utilizzo delle API per interazioni con i lampioni                                                                                                          
	& Eseguito uno studio approfondito sull'utilizzo del API  e comunicato con membri del gruppo che le hanno già utilizzate                                                                                              
	& Le API messe a disposizione ora si interfacciano correttamente con i lampioni                                                                                                                                                  \\ \hline
	\multicolumn{4}{|c|}{\textbf{Sprint 11}  }                                                                                                                                                                                                                                                                                                                                                                   \\ \hline
	-   & Nessun rischio riscontrato.                                                                                                           
	& -                                                                                               
	& -                                                                                                                                                   \\ \hline
	\multicolumn{4}{|c|}{\textbf{Sprint 12}  }                                                                                                                                                                                                                                                                                                                                                                  \\ \hline
	\textbf{RT1}   & Difficoltà nella scelta dell'architettura adatta alla soluzione del problema                                                                                                         
	& Dedicate ore di approfondimento e ripasso alle architetture note e non                                                                                            
	& È stata decisa l'architettura da implementare per l'MVP                                                                                                                                                 \\ \hline
	\multicolumn{4}{|c|}{\textbf{Sprint 13}  }                                                                                                                                                                                                                                                                                                                                                                   \\ \hline
	\textbf{RI2} & Nessun rischio riscontrato                          
	& - 
	& - \\ \hline
	\textbf{RT1} & Nessun rischio riscontrato                          
	& -
	& - \\ \hline
	\multicolumn{4}{|c|}{\textbf{Sprint 14}  }                                                                                                                                                                                                                                                                                                                                                                   \\ \hline
	\textbf{RT2} & Difficoltà nel passaggio dal vecchio back-end al nuovo                          
	& Incentivata la comunicazione tra i membri del gruppo che si sono occupati del back end, in modo da facilitarne il passaggio
	& Il back-end, seppur non concluso, è stato sostituito correttamente a quello vecchio \\ \hline
	\multicolumn{4}{|c|}{\textbf{Sprint 15}  }                                                                                                                                                                                                                                                                                                                                                                   \\ \hline
	- & Nessun rischio riscontrato.                          
	& - 
	& - \\ \hline	
	\multicolumn{4}{|c|}{\textbf{Sprint 16}  }                                                                                                                                                                                                                                                                                                                                                                   \\ \hline
	-   & Nessun rischio riscontrato.                                                                                                           
	& -                                                                                               
	& -                                                                                                                                                   \\ \hline
	\multicolumn{4}{|c|}{\textbf{Sprint 17}  }                                                                                                                                                                                                                                                                                                                                                                   \\ \hline
	\textbf{RR3}   & È stata riscontrata una difficoltà nell'organizzare l'incontro con il proponente per via di impegni lavorativi di quest'ultimo.     
		& È stato sollecitata la necessità di un incontro per mostrare il lavoro fatto, dando massima flessibilità sull'ora di incontro    
        & È stato fissato l'incontro in data 9/13/2023 alle ore 17:00.                                                                                                                                                 \\
\end{xltabular}
