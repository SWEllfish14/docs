...
\subsection{UC1 - Accesso al sistema con credenziali}
...
\subsection{UC2 - Visualizzazione stato sistema}
\textbf{Tipologia: obbligatorio} \\
...
\subsection{UC3 - Aumento luminosità manuale}
\textbf{Tipologia: obbligatorio} \\
...
\subsubsection{UC3.1 - Visualizzazione del messaggio d'errore}
\begin{itemize}
...
\subsection{UC4 - Diminuzione luminosità manuale}
\textbf{Tipologia: obbligatorio} \\
...
\subsection{UC5 - Inserimento nuova area illuminata}
\textbf{Tipologia: obbligatorio} \\
...
\subsection{UC6 - Rimozione area illuminata}
\textbf{Tipologia: obbligatorio} \\
...
\subsection{UC7 - Modifica informazioni area illuminata}
\textbf{Tipologia: obbligatorio} \\
...
\subsubsection{UC7.1 - Visualizzazione del messaggio d'errore in modalità di modifica}
\begin{itemize}
	\item Attore primario: SuperAdmin, Admin
...
\subsection{UC8 - Inserimento nuovo sensore}
\textbf{Tipologia: obbligatorio}\\
...
\subsection{UC9 - Rimozione sensore}
\textbf{Tipologia: obbligatorio}\\
...
\hline
RF3.1 & Viene visualizzato un messaggio d'errore se non si è potuto aumentare la luminosità & Obbligatorio & UC3.1 \\
\hline
RF4 & L'utente deve poter diminuire la luminosità & Obbligatorio & UC4 \\
\hline
RF5 & L'utente deve poter inserire una nuova area illuminata & Obbligatorio & UC5 \\
\hline
RF6 & L'utente deve poter rimuovere una nuova area illuminata & Obbligatorio & UC6 \\
\hline
RF7 & L'utente deve poter modificare le informazioni di una zona illuminata & Obbligatorio & UC7 \\
\hline
RF7.1 & Viene visualizzato un messaggio d'errore se non si è potuta effetuare la modifica & Obbligatorio & UC7.1 \\
\hline
RF8 & L'utente deve poter inserire un nuovo sensore in una zona illuminata & Obbligatorio & Capitolato UC8 \\
\hline
RF9 & L'utente deve poter rimuovere un sensore da una zona illuminata & Obbligatorio & UC9 \\
\hline
RF10 & L'utente deve poter fare il logout dal sistema & Obbligatorio & Capitolato UC10 \\
\hline
RF11 & L'utente visualizza l'elenco delle aree illuminate & Obbligatorio & UC11 \\
\hline
RF12 & L'utente deve poter inserire un impianto nell'elenco dei guasti & Obbligatorio & UC12 \\
\hline
RF13 & L'utente deve poter rimuovere un impianto dall'elenco dei guasti & Obbligatorio & UC13 \\
\hline
RF14 & L'utente visualizza i dettagli di una zona & Obbligatorio & UC14 \\
\hline
RF15 & L'utente visualizza i dettagli di un lampione & Obbligatorio & UC15 \\
\hline
RF16 & L'utente deve poter inserire un nuovo lampione all'interno di un'area illuminata & Obbligatorio & UC16 \\
\hline
RF17 & L'utente deve poter rimuovere un lampione all'interno di un'area illuminata & Obbligatorio & UC17 \\
\hline
RF18 & L'utente visualizza l'elenco delle aree illuminate con dei malfunzionamenti & Obbligatorio & UC18 \\
\hline
RF19 & L'amministratore apre una nuova segnalazione di un guasto tramite un ticket & Obbligatorio & UC19 \\
\hline
RF20 & L'amministratore chiude il ticket dopo aver fatto la dovuta manutenzione & Obbligatorio & UC20 \\
\hline
RF21 & Il manutentore visualizza i dettagli aggiuntivi di un guasto forniti dal ticket & Obbligatorio & UC21 \\
\hline
RF22 & L'utente non amministratore riceve le credenziali da amministratore da un superamministratore & Desiderabile & UC22 \\
\hline
RF23 & L'utente consulta il manuale Lumos Minima & Desiderabile & UC23 \\
\hline
RF24 & Le nuove zone illuminate appena inserite hanno un setup standard & Desiderabile & UC24 \\
\hline
\end{xltabular}
