...
\subsection{User Case 14 - Registrazione a sistema}

\subsection{User Case 15 - Cifratura comunicazioni}
...
\begin{itemize}
	...
	\item Postcondizioni: le operazioni vengono eseguite in sicurezza, senza interferenze di terzi maleintenzionati
\end{itemize}
\paragraph{Scenario Principale}
\begin{itemize}
...
\subsection{User Case 16 - Analisi carico massimo del server e possibile migrazione du cloud}

\subsection{User Case 17 - Configurazione iniziale delle impostazioni di una nuova zona illuminata}
\textbf{Tipologia: desiderabile} \\
...
\end{itemize}
\subsection{User Case 18 - Logout dal sistema}
\textbf{Tipologia: obbligatorio} \\
...
\subsection{User Case 19 - Visualizzazione elenco aree illuminate}
\textbf{Tipologia: obbligatorio} \\
...
\subsection{User Case 20 - Inserimento di un impianto nella sezione guasti}
\textbf{Tipologia: obbligatorio} \\
...
\subsection{User Case 21 - Rimozione di un impianto dalla sezione guasti}
\textbf{Tipologia: obbligatorio} \\
