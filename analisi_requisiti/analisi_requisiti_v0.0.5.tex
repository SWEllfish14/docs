...
\begin{itemize}
	\item Attori primari: amministratori di sistema, SuperAdmin
...
\begin{itemize}
	\item Attori primari: Amministratore di sistema, manutentori
...
\begin{itemize}
	\item Attore primario: amministratore di sistema.
...
\subsection{User Case 15 - Logout dal sistema}
\textbf{Tipologia: obbligatorio} \\
...
\subsection{User Case 16 - Visualizzazione elenco aree illuminate}
\textbf{Tipologia: obbligatorio} \\
...
\subsection{User Case 17 - Inserimento di un impianto nella sezione guasti}
\textbf{Tipologia: obbligatorio} \\
...
\subsection{User Case 18 - Rimozione di un impianto dalla sezione guasti}
\textbf{Tipologia: obbligatorio} \\
...
\subsection{User Case 19 - Visualizzazione dettagliata di una zona}
\textbf{Tipologia: obbligatorio} \\
...
\subsection{User Case 20 - Visualizzazione dettagliata di un lampione}
\textbf{Tipologia: obbligatorio} \\
...
\subsection{User Case 21 - Inserimento di un lampione}
\textbf{Tipologia: obbligatorio}\\
...
\subsection{User Case 22 - Rimozione lampione}
\textbf{Tipologia: obbligatorio}\\
